...
class ProfileUpdateDriverScreen extends StatefulWidget {
  ProfileUpdateDriverScreen({
  ...
  @override
  State<ProfileUpdateDriverScreen> createState() =>
      _ProfileUpdateDriverScreenState();
}

class _ProfileUpdateDriverScreenState extends State<ProfileUpdateDriverScreen> {
  ...
  void _loadUserInfo() {
    ...
    _driverLicenceController.text = widget.sessionController.driverLicense ?? '';
  ...
  Future<void> _saveChanges() async {
    ...
    try {
      if (_imageUrl != null) {
        await widget.sessionController.updateDriver(
          DriverProfile(
