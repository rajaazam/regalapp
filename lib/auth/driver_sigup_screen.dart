...
class _DriverSignUpScreenState extends State<DriverSignUpScreen> {
  ...
  final fireStore = FirebaseFirestore.instance.collection('Driver');
  ...
  Future<void> _signUp() async {
    ...
    try {
      ...
      await fireStore.doc(userId).set({
        ...
        'driverCNIC': driverProfile.driverCNIC,
        // 'Driver_License': driverProfile.driverLicense,
        'id': id,
        'driverId': driverProfile.driverId,
        'driverLicense':driverProfile.driverLicense
      });
                      ...
                      TextFormField(
                        ...
                        validator: (value) {
                          ...
                          if (int.tryParse(value[value.length - 1]) == null ||
                              int.parse(value[value.length - 1]) % 2 != 0) {
                            return 'only for female CNIC,';
                          }
                          return null;
                        },
                      ),
